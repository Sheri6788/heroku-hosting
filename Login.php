...
// Check if the admin is already logged in and redirect if necessary
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark border-bottom border-top border-warning border-5">
        <div class="container">
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                data-bs-target="#navbarcollapseCMS" aria-controls="navbarcollapseCMS" aria-expanded="false"
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text text-white bg-info"
                                                style="height:100%; border-radius: 5px 0px 0px 5px;"><i
