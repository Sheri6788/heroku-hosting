...
<div class="container mt-5">
    <div class="row">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <small class="text-muted">Category: <span class="text-dark"><a
                            ...
                            & Written by <span class="text-dark"><?php echo htmlentities($Admin); ?></span> on <span
                ...
                <div>
                    <div class="media CommentBlock p-3 mb-3">
                        <div class="media-body ml-2">
                            <h6 class="lead"><span class="align-self-center me-2"><i
                                            class="fas fa-user fa-lg"></i></span><?php echo $CommentName; ?></h6>
        ...
        <!-- SIDE AREA -->
        <div class="col-sm-4"> <!-- or use class col-sm-3 offset-sm-1 to put an empty column before -->
            <div class="card mt-4 mb-3">
                <div class="card-body">
                    ...
                    <div class="text-center">
                        ...
                        was popularized in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages,
                        ...
                        <div class="media">
                            ...
                            <div class="media-body ml-2">
                                <a href="FullPost.php?id=<?php echo htmlentities($Id); ?>" target="_blank"
                                   class="heading"><h6 class="lead"><?php echo htmlentities($Title); ?></h6></a>
