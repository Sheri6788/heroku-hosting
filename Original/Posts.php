...
<!-- GRAB DB CONNECTION -->
                    ...
                    <tr>
                        ...
                        <td>
                            <?php 
                            if (strlen($Category)>8){$PostTitle=substr($PostTitle,0,8)."...";}
                            echo $Category; 
                            ?>
                        </td>
                        <td>
                            <?php 
                            if (strlen($DateTime)>11){$PostTitle=substr($PostTitle,0,11)."...";}
                            echo$DateTime; 
                            ?>
                        </td>
                        <td>
                            <?php 
                            if (strlen($Admin)>6){$PostTitle=substr($PostTitle,0,6)."...";}
                            echo $Admin; 
                            ?>
                        </td>
                        ...
                        <td><a href="FullPost.php?id=<?php echo $Id; ?>" target="blank"><span class="btn btn-primary">Live Preview</span></a></td>
                    </tr>
                    <?php }?>
            ...
            <nav>
              <ul class="pagination pagination-lg">
                ...
                $PostPagination= ceil($PostPagination); //Remove decimal, how many page (floor: to round it to bottom)
                //echo $PostPagination;
