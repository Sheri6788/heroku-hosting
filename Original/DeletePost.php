              ...
              <div class="card bg-secondary text-light">
                ...
                <div class="card-body bg-dark">
                  ...
                  <div class="form-group mb-3">
                    ...
                    <input disabled class ="form-control" type="text" name="PostTitle" id="title" placeholder = "Type title heare..." value="<?php echo $TitleToBeDeleted;?>">
                  </div>
                  ...
                  <div class="form-group mb-3">
                    ...
                    <img class="mb-1" src="Uploads/<?php echo $ImageToBeDeleted;?>" width="170px" height="100px"> <br>
